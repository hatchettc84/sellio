...
// @ts-expect-error - React 19 type incompatibility with Next.js Image
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <Link href="/sign-in">
                <button className="px-8 py-3 rounded-lg bg-white text-black font-medium hover:bg-white/90 transition-colors">
                  Sign In
                </button>
              </Link>
              <Link href="/sign-up">
                <button className="px-8 py-3 rounded-lg bg-gradient-to-r from-indigo-500 to-rose-500 text-white font-medium hover:opacity-90 transition-opacity">
                  Get Started
                </button>
              </Link>
            </div>
